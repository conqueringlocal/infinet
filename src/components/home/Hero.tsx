...
const Hero = () => {
  ...
  return (
    <div 
      ref={heroRef}
      className="relative pt-32 pb-24 md:pt-40 md:pb-32 overflow-hidden bg-gradient-to-br from-gray-50 to-blue-50"
    >
      {/* Background Elements */}
      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-infinet-400 to-infinet-600"></div>
      <div className="absolute bottom-0 right-0 w-full h-full max-w-3xl -z-10 opacity-10 translate-x-1/4">
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          <path fill="#0459ab" d="M53.6,-65.3C67.6,-53.1,76.3,-34.6,79.7,-15.3C83.1,4,81.2,24.2,71.8,39.4C62.3,54.5,45.3,64.6,27.7,70C10.2,75.3,-7.9,75.9,-25.6,71.1C-43.4,66.3,-60.8,56.1,-70.1,40.7C-79.3,25.3,-80.4,4.7,-77,-15.4C-73.7,-35.5,-65.8,-55,-51.2,-67.2C-36.6,-79.4,-15.3,-84.3,2.6,-87.4C20.6,-90.5,39.6,-77.6,53.6,-65.3Z" transform="translate(100 100)" />
        </svg>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-5xl mx-auto">
          <div className="text-center space-y-8">
            {/* Tagline Chip */}
            <div className="reveal inline-block bg-infinet-100 text-infinet-800 px-4 py-1 rounded-full text-sm font-medium mb-6">
