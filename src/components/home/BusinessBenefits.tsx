        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <InteractiveCard variant="default" hoverEffect="lift" className="text-center">
            <div className="flex flex-col items-center">
              <div className="bg-infinet-100 p-3 rounded-full mb-3">
                <Briefcase className="h-6 w-6 text-infinet-600" />
              </div>
              <h4 className="font-semibold text-gray-900">Turnkey Solutions</h4>
          ...
          <InteractiveCard variant="default" hoverEffect="lift" className="text-center">
            <div className="flex flex-col items-center">
              <div className="bg-infinetYellow-100 p-3 rounded-full mb-3">
                <Clock className="h-6 w-6 text-infinetYellow-600" />
              </div>
              <h4 className="font-semibold text-gray-900">Minimal Disruption</h4>
              <p className="text-sm text-gray-600 mt-2">
          ...
          <InteractiveCard variant="default" hoverEffect="lift" className="text-center">
            <div className="flex flex-col items-center">
              <div className="bg-infinet-100 p-3 rounded-full mb-3">
                <CheckCircle2 className="h-6 w-6 text-infinet-600" />
              </div>
          ...
          <InteractiveCard variant="default" hoverEffect="lift" className="text-center">
            <div className="flex flex-col items-center">
              <div className="bg-infinetYellow-100 p-3 rounded-full mb-3">
                <Award className="h-6 w-6 text-infinetYellow-600" />
              </div>
